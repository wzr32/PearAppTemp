  ...
  return (
    <Box component="section"  sx={{ minHeight: "100vh", marginTop:"4rem"}}>
      <Grid container spacing={2} alignItems="center">
        ...
        <Grid item md={8}>
          <Typography variant="h3" textAlign="center" color={LIGHT_GREEN_COLOR} maxWidth="400px" margin={"0 auto .5rem auto"}>What is Pear?</Typography>
          <Typography variant="body1" component="span" display="flex" justifyContent="center" textAlign="center" maxWidth="400px" margin={"1rem auto 0 auto"}>
            Pear is a search tool that filters the best solutions for you, tailored 
            to your needs, facilitating the choice of platform according to your 
            characteristics as a consumer.
          </Typography>
        </Grid>
        <Grid item md={4}>
