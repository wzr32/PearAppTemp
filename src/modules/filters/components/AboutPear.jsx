  ...
  return (
    <Box component="section" sx={{ margin: "4rem 0 4rem 0" }} >
      <Grid container alignItems={"center"}>
        <Grid item md={7}>
          <Typography variant="h3" textAlign="center" margin={"0rem auto 1rem auto"}>What is Pear?</Typography>
          <Typography variant="h5" textAlign="center" color={DARK_GREEN_COLOR} margin={"2rem auto 0 auto"}>Lorem ipsum dolor sit amet, consectetur </Typography>
